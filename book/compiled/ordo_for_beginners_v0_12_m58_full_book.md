---
title: "Ordo для чайників"
subtitle: "Повна книга: актуальна збірка після M57"
author: "Ordo project"
date: "2026-07-06"
lang: uk-UA
---
...
<!-- source: 00_title.md | title: Ordo для чайників -->

# Ordo для чайників

![Nebu — маскот Ordo](../source/assets/mascots/256x256/Nebu_base_256x256.png)

## Як перетворювати людські інструкції на чіткі виконувані інструкції для AI-моделей

Робочий рукопис для мови **Ordo**.

**Статус:** чернетка для вичитки, структурування, ілюстрування та подальшої підготовки PDF / GitHub-пакета.



<!-- source: 01_peredmova.md | title: Передмова -->

# Передмова

![Nebu — ідея](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
Ця книга не є академічним стандартом і не є фінальною специфікацією. Це пояснення “для чайників”: з прикладами, аналогіями, простими формулюваннями і поступовим переходом від звичайного prompt-а до мови керування AI-моделлю.

Головна мета книги — допомогти читачеві зрозуміти не тільки синтаксис Ordo, а спосіб мислення за ним.



<!-- source: 02_dlia_koho_tsia_knyha.md | title: Для кого ця книга -->

# Для кого ця книга

![Nebu — це цікаво](../source/assets/mascots/64x64/Nebu_interesting_64x64.png)
...
<!-- source: 03_yak_chytaty_knyhu.md | title: Як читати цю книгу -->

# Як читати цю книгу

![Nebu — подумати](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: 04_vstup_holovna_ideia_ordo.md | title: Вступ. Головна ідея Ordo -->
...
<!-- source: chapter_01_chomu_zvychainykh_promptiv_nedostatno.md | title: Розділ 1. Чому звичайних prompt-ів недостатньо -->

# Розділ 1. Чому звичайних prompt-ів недостатньо

![Nebu — увага](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
<!-- source: chapter_02_shcho_take_ordo_prostymy_slovamy.md | title: Розділ 2. Що таке Ordo простими словами -->
...
<p><img src="../source/assets/mascots/64x64/Nebu_idea_64x64.png" alt="Nebu idea" width="64" /></p>
...
<p><img src="../source/assets/mascots/64x64/Nebu_attention_64x64.png" alt="Nebu attention" width="64" /></p>
...
<p><img src="../source/assets/mascots/64x64/Nebu_thinking_64x64.png" alt="Nebu thinking" width="64" /></p>
...
<p><img src="../source/assets/mascots/64x64/Nebu_interesting_64x64.png" alt="Nebu interesting" width="64" /></p>
...
<!-- source: chapter_03_ordo_iak_mova_keruvannia_modelliu.md | title: Розділ 3. Ordo як мова керування моделлю -->
...
<!-- source: chapter_04_intent_contract_context.md | title: Розділ 4. Intent, Contract, Context -->
...
![Nebu — важливо: статус контракту](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: обмежений контекст](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
![Nebu — ідея: стартовий шаблон](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
<!-- source: chapter_05_state_pamiat_protsesu.md | title: Розділ 5. State: памʼять процесу -->
...
![Nebu — ідея: State як памʼять процесу](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — подумати: Context проти State](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
![Nebu — увага: State блокує передчасний фінал](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
<!-- source: chapter_06_entry_i_node_iak_model_stavyt_pytannia.md | title: Розділ 6. Entry і Node: як модель ставить питання -->
...
![Nebu — ідея: Entry як точка входу](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: не ставити всі питання одразу](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: межі одного node](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_07_output_shcho_model_maie_stvoryty.md | title: Розділ 7. Output: що модель має створити -->
...
![Nebu — ідея: Output як контракт результату](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: Output дозволений тільки після gates](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: blocked handoff теж результат](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_08_pyshemo_pershu_ordo_source_prohramu.md | title: Розділ 8. Пишемо першу Ordo Source-програму -->
...
![Nebu — ідея: Ordo Source як перша програма](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: не запихати правила в intent](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: gate як місце перевірки](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_09_kompiliuiemo_ordo_source_v_semantic_json_ir.md | title: Розділ 9. Компілюємо Ordo Source в Semantic JSON IR -->
...
![Nebu — ідея: компіляція як перехід до виконання](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: компіляція не має спотворювати сенс](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: source map зберігає звʼязок із людським текстом](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_10_chomu_semantic_json_ir_zaraz_naikrashchyi.md | title: Розділ 10. Чому Semantic JSON IR зараз найкращий -->
...
![Nebu — ідея: IR як форма виконання](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: компактність не завжди допомагає](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: одна інструкція у трьох формах](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_11_gate_tse_ne_porada_a_kontrolna_tochka.md | title: Розділ 11. Gate — це не порада, а контрольна точка -->
...
![Nebu — ідея: Gate як контрольна точка](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: hard stop сильніший за бажання завершити відповідь](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: Gate має мати evidence](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_12_nehatyvni_perevirky_assert_not.md | title: Розділ 12. Негативні перевірки: ASSERT.NOT -->
...
![Nebu — ідея: ASSERTION як захист від заборонених дій](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: позитивна перевірка не ловить зайве](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: FREEFORM не повинен ховати контрольні правила](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_13_status_semantics.md | title: Розділ 13. Status semantics -->
...
![Nebu — ідея: статус як контрольована позиція процесу](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: коротка відповідь діє тільки в межах поточного вузла](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: статус має залишати слід](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_14_chomu_ordo_prohramy_potribno_debazhyty.md | title: Розділ 14. Чому Ordo-програми потрібно дебажити -->
...
![Nebu — ідея: debug як частина мови](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: правильний результат може бути отриманий неправильним шляхом](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: trace не є приватним chain of thought](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_15_debug_mode_i_execution_trace.md | title: Розділ 15. Debug mode і execution trace -->

# Розділ 15. Debug mode і execution trace
...
![Nebu — ідея: debug mode показує шлях виконання](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: trace не є chain of thought](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: path explain показує не тільки вибір](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_16_testy_fixtures_i_expected_behavior.md | title: Розділ 16. Тести, fixtures і expected behavior -->
...
![Nebu — ідея: тест перевіряє поведінку процесу](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: тестувати треба не тільки фінальний output](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: no-op теж очікувана поведінка](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_17_regression_suite_i_coverage.md | title: Розділ 17. Regression suite і coverage -->
...
![Nebu — ідея: regression suite захищає поведінку](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: gate без method не є повноцінним gate](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — увага: coverage не дорівнює якості](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: бібліотечна зміна може зламати багато playbook-ів](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_18_feedback_and_improvement_loop.md | title: Розділ 18. Feedback & Improvement Loop -->
...
![Nebu — ідея: feedback має ставати артефактом](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: feedback не застосовується без підтвердження](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: повторюваний feedback може показати, що FREEFORM треба формалізувати](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_19_chomu_ne_vse_treba_formalizuvaty.md | title: Розділ 19. Чому не все треба формалізувати -->
...
![Nebu — ідея: формалізація має зберігати баланс](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: критичне правило не можна ховати в поясненні](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: FREEFORM має пояснювати правило, а не замінювати його](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_20_iak_pravylno_vykorystovuvaty_freeform.md | title: Розділ 20. Як правильно використовувати FREEFORM -->
...
![Nebu — ідея: FREEFORM як контрольований фрагмент](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: FREEFORM не може ховати обовʼязкові правила](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: формальна структура має пріоритет над FREEFORM](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_21_freeform_coverage.md | title: Розділ 21. FREEFORM.COVERAGE -->
...
<!-- source: chapter_22_ordo_core.md | title: Розділ 22. Ordo Core -->
...
![Nebu — ідея: Core як скелет мови](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — подумати: не змішувати Core, Profile, Domain Pack і Library](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
![Nebu — увага: Core не має ставати занадто великим](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
<!-- source: chapter_23_ordo_profiles.md | title: Розділ 23. Ordo Profiles -->
...
![Nebu — ідея: Profile як режим роботи](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — подумати: розділення Core, Profile, Domain і Library](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
![Nebu — увага: Profile змінює контракт виконання](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
<!-- source: chapter_24_domain_packs.md | title: Розділ 24. Domain Packs -->
...
![Nebu — ідея: Domain Pack як предметний шар Ordo](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — подумати: Domain Pack не замінює Core або Profile](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
![Nebu — увага: Domain Pack не повинен переписувати Core](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
<!-- source: chapter_25_biblioteky_ordo_include_import_i_povtorne_vykorystannia_hotovykh_rishen.md | title: Розділ 25. Бібліотеки Ordo: include, import і повторне використання готових рішень -->
...
![Nebu — ідея: бібліотека як явний пакет поведінки](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — подумати: include не означає автоматичне використання всього](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
![Nebu — увага: override має бути явним](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
<!-- source: chapter_26_chomu_all_in_one_bilshe_ne_holovnyi_format.md | title: Розділ 26. Чому all-in-one більше не головний формат -->
...
<!-- source: chapter_27_documentation_runtime.md | title: Розділ 27. Documentation Runtime -->
...
<!-- source: chapter_28_rendered_artifact_validation.md | title: Розділ 28. Rendered artifact validation -->
...
![Nebu — ідея: перевіряємо фактично створений артефакт](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: failed validation блокує handoff](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: consistency часто ламається між файлами](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_29_staryi_playbook_iak_markdown_baza_znan.md | title: Розділ 29. Старий playbook як markdown-база знань -->
...
![Nebu — ідея: markdown-playbook є базою знань, а не runtime](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — увага: all-in-one небезпечний як runtime source](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
![Nebu — подумати: потрібно зберегти звʼязок між старим текстом і Ordo-обʼєктами](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
<!-- source: chapter_30_mihratsiia_playbook_a_v_ordo.md | title: Розділ 30. Міграція playbook-а в Ordo -->
...
![Nebu — ідея: міграція перетворює знання на виконувану структуру](../source/assets/mascots/64x64/Nebu_idea_64x64.png)
...
![Nebu — подумати: прихована логіка має стати явними вузлами, станом і gates](../source/assets/mascots/64x64/Nebu_thinking_64x64.png)
...
![Nebu — увага: без зібраного contract не можна переходити до фінального output](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
<!-- source: chapter_31_guided_intake_iak_ordo_prohrama.md | title: Розділ 31. Guided intake як Ordo-програма -->
...
<!-- source: chapter_32_package_generation.md | title: Розділ 32. Package generation -->
...
<!-- source: chapter_33_shcho_lyshylos_u_freeform.md | title: Розділ 33. Що лишилось у FREEFORM -->
...
<!-- source: chapter_34_minimalni_vymohy_do_avtora.md | title: Розділ 34. Мінімальні вимоги до автора -->
...
<!-- source: chapter_35_iak_ne_zlamaty_playbook.md | title: Розділ 35. Як не зламати playbook -->
...
<!-- source: chapter_36_iak_otsiniuvaty_pokryttia_ordo.md | title: Розділ 36. Як оцінювати покриття Ordo -->
...
<!-- source: chapter_37_ordo_bez_runtime.md | title: Розділ 37. Ordo без runtime -->
...
<!-- source: chapter_38_ordo_z_helper_runner.md | title: Розділ 38. Ordo з helper-runner -->
...
![Nebu — зверніть увагу](../source/assets/mascots/64x64/Nebu_attention_64x64.png)
...
<!-- source: chapter_39_ordo_iak_native_model_language.md | title: Розділ 39. Ordo як native model language -->
...
<!-- source: chapter_40_process_rail.md | title: Розділ 40. Process Rail: як Ordo тримає ШІ на маршруті -->
...
<!-- source: chapter_41_contract_artifact_coverage_go_no_go.md | title: Розділ 41. Contract → Artifact Coverage і Go/No-Go -->
...
<!-- source: chapter_42_external_audit_pre_release.md | title: Розділ 42. Зовнішній аудит pre-release пакета -->
...
<!-- source: chapter_43_final_handoff.md | title: Розділ 43. Final handoff: як передавати Ordo на зовнішню перевірку -->
...
<!-- source: chapter_44_external_feedback_intake.md | title: Розділ 44. Прийом зовнішнього feedback після review -->
...
<!-- source: chapter_45_feedback_decision_planning.md | title: Розділ 45. Feedback decision planning -->
...
<!-- source: chapter_46_publication_readiness_decision.md | title: Розділ 46. Publication readiness decision -->
...
<!-- source: chapter_47_two_tier_rendering_model.md | title: Розділ 47. Two-tier rendering model -->
...
<!-- source: chapter_48_runtime_source_of_truth.md | title: Розділ 48. Runtime source of truth і чесність CLI -->
...
<!-- source: chapter_49_runtime_guided_intake_entry_protocol.md | title: Розділ 49. Runtime Guided Intake Entry Protocol -->

# Розділ 49. Runtime Guided Intake Entry Protocol

M54 додає ще один захисний шар: AI Ordo Developer не має починати guided intake “з памʼяті”. Якщо пакет має runtime, робота починається з `START_HERE_RUNTIME_MODE.md`, `ordo.yml` і актуального `compiled/program.ir.json`.
...
Команда `ordo runtime-entry` перевіряє, що пакет можна завантажити як один runtime workspace, а не як хаотичний набір файлів. Вона також повертає перший node/question із compiled IR.

Після кожної відповіді AI показує тільки короткий протокол:
...
Це не замінює `validate-state`, `validate-output`, `validate-artifacts`, `consistency` або `go-no-go`. Це стартовий guard, який не дає моделі почати неправильний flow.

PDF книги в M54 не перегенеровувався.



<!-- source: chapter_50_runtime_mode_start_files_standard.md | title: Розділ 50. Runtime Mode start files standard -->
...
<!-- source: chapter_51_package_build_profiles.md | title: Розділ 51. Package build profiles: dev / runtime / evidence -->
...
<!-- source: chapter_52_runtime_checkpoint_discipline.md | title: Розділ 52. Runtime Checkpoint Discipline -->
...
<!-- source: appendix_a_slovnyk_ordo.md | title: Додаток A. Словник Ordo -->
...
<!-- source: appendix_b_kataloh_op_kodiv.md | title: Додаток B. Каталог op-кодів -->
...
<!-- source: appendix_c_pryklady_prohram.md | title: Додаток C. Приклади програм -->
...
<!-- source: appendix_d_cheklysty.md | title: Додаток D. Чеклисти -->
...
<!-- source: appendix_e_antypaterny.md | title: Додаток E. Антипатерни -->
