...
For current work, start with [`PROJECT_TRACKING.md`](../PROJECT_TRACKING.md). The M60.8 handoff and historical stable package index are available from the external provenance archive documented in [`../EXTERNAL_ARCHIVES.md`](../EXTERNAL_ARCHIVES.md).
