...
Download [ARF Playbook Kit 0.4.2](https://github.com/solo-vey/Ordo/releases/download/arf-playbook-kit-v0.4.2/ORDO_ARF_PLAYBOOK_KIT_0.4.2.zip). Keep the archive intact.
