...
## M63.2 validation profile update

M63.2 formalizes the rc.1 validation profile. `validate-factory-output` remains APF-local / optional; `consistency: passed_with_warnings` remains visible and non-blocking. The APF clean-source package includes `reports/CLI_VALIDATION_SUMMARY.md` as a required lint-visible validation summary.
