# M61.1 Companion Utility Handoff Note

M61.1 is a docs-only consolidation for Ordo companion utilities. It does not change runtime-core behavior or PathWalk feature behavior.

Stable included utility: PathWalk.  
Planned utility import: Visual Graph Generator in M61.2.
...
M61.0 extends the artifact-only real-module path with a human-review layer:
...
This remains review/QA preparation. It does not execute runtime, score model behavior, calibrate weights, or reopen watchdog/process-boundary hardening.
