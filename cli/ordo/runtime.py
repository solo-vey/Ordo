...
def load_runtime_source(package_path: str | Path) -> tuple[Path, dict[str, Any], dict[str, Any], dict[str, Any]]:
    ...
    for op in ops:
        ...
        if op_name == "CONTRACT.DEF":
            ...
            source["regression_contract"] = {k: v for k, v in op.items() if k not in {"op", "id"}}
            ...
            source["nodes"].append({
                ...
                "navigation_contract": op.get("navigation_contract") or {},
                "terminal": op.get("terminal", False),
            ...
            source["gates"].append({
                ...
                "pass_to": op.get("pass_to"),
                "fail_to": op.get("fail_to"),
                "transitions": op.get("transitions") or [],
                "navigation_contract": op.get("navigation_contract") or {},
                "terminal": op.get("terminal", False),
                "allowed_from": op.get("allowed_from") or [],
