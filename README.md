...
1. [Download the ARF Playbook Kit 0.4.3](https://github.com/solo-vey/Ordo/releases/download/arf-playbook-kit-v0.4.3/ORDO_ARF_PLAYBOOK_KIT_0.4.3.zip).
...
No local installation is required for this route. The Kit contains the ARF rules, prompts, template, full factory runtime, test-and-improve prompt, decision debug trace guidance, document-field provenance validation guidance, graph transition contract, and delivery contract. Its [checksum](https://github.com/solo-vey/Ordo/releases/download/arf-playbook-kit-v0.4.3/ORDO_ARF_PLAYBOOK_KIT_0.4.3.zip.sha256) is published beside the ZIP.
