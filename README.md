...
1. [Download the ARF Playbook Kit 0.3.0](https://github.com/solo-vey/Ordo/releases/download/arf-playbook-kit-v0.3.0/ORDO_ARF_PLAYBOOK_KIT_0.3.0.zip).
...
No local installation is required for this route. The Kit contains the ARF rules, prompts, template, full factory runtime, test-and-improve prompt, decision debug trace guidance, and delivery contract. Its [checksum](https://github.com/solo-vey/Ordo/releases/download/arf-playbook-kit-v0.3.0/ORDO_ARF_PLAYBOOK_KIT_0.3.0.zip.sha256) is published beside the ZIP.
