# Human Review Scenario Card — CARD_007_NOISE_TP_001_SKIP_AHEAD

Milestone: `M61.0`
Case: `NOISE_TP_001_SKIP_AHEAD`
...
|---:|---|---|---|---|---|
| 0 | `N_ISSUE_SUMMARY` | `skip_ahead` | `high` | do_not_skip_required_current_node_or_advance_out_of_order | `False` |
