# Recovery and trust status

## Головне

Під час роботи над BL-ORDO-032 активний workspace/checkpoint кілька разів втрачався або ставав недоступним. Це прямо викликало проблему неакуратного відновлення, яку користувач окремо відзначив.

Після closure ми **не мали exact final canonical tree**. Було виконано максимальне відновлення з останнього повного BL-ORDO-027 baseline.

Нижче — recovery report, який є source-of-truth для довіри до відновленого пакета.
