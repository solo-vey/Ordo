# Start Prompt — Office Opening Ordo RC19 — S05_INCOMPLETE_HARD_STOP

SCENARIO_ID: `S05_INCOMPLETE_HARD_STOP`
...
```bash
python3 tools/select_scenario.py . --scenario S05_INCOMPLETE_HARD_STOP
```
