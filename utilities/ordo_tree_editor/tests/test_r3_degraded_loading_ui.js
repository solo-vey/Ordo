...
for(const token of [
  ...
  'capability={tree:"show_tree",lineage:"show_data_flow",settings:"playbook_settings",verification:"verification",packagefiles:"package_files",chat:"execute",replay:"replay"}',
