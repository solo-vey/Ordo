...
const tabSeq=['data-workspace-tab="upload">Upload Playbook','data-workspace-tab="tree">Show Tree','data-workspace-tab="lineage">Show Data Flow','data-workspace-tab="settings">Playbook Settings','data-workspace-tab="verification">Verify Playbook','data-workspace-tab="packagefiles">Package Files','data-workspace-tab="chat">Execute Playbook','data-workspace-tab="replay">Replay Real Chat','data-workspace-tab="modelchat">Model Chat','data-workspace-tab="help">Help'];
