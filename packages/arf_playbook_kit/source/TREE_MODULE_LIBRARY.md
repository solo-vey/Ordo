...
Factory may recommend a template when an output artifact or final handoff is
being designed. Recommendation is optional: declining it continues the manual
authoring route unchanged.
