...
Implemented in alpha.22 through `REPRESENTATION_REGISTRY.json`, four versioned profiles, schema, validator, fixtures, acceptance report, and decision-tree nodes `N079`–`N084` plus gate `G_REPRESENTATION_COMPILATION_GOVERNANCE`.
