...
## Verification inheritance artifacts

These are mandatory package-level control artifacts for every runnable generated playbook and are not optional business outputs:
...
Domain-specific deterministic validators belong under `tools/` and are referenced by the responsibility map and verification profile.
